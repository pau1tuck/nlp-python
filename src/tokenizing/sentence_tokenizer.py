...
sentences_v1 = sent_tokenize(paragraph)
sentences_v2 = sentence_tokenizer.tokenize(paragraph)

print('Number of sentences: ', len(sentences_v1))

for sentence in sentences_v2:
    print(sentence, '\n')
